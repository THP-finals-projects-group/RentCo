class Case < ApplicationRecord
    ...
    # COMPUTE CALCUL
    after_create :compute_user_part
    after_update :compute_user_part, :compute_pre_estimation_renovation, :compute_finals_calculs
    ...
    def compute_pre_estimation_renovation
